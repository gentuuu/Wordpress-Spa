...
<div class="main-blog">
	<div class="container">
		<div class="main-blog-section">
			<div class="blog__title">Artykuły z tag: <?php single_term_title(); ?></div>
			<div class="main-blog-items">
				...
				<div class="main-blog-item">
					...
					<div class="main-blog-item__row">
						...
						<div class="main-blog-item__text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit
							praesentium
							distinctio</div>
